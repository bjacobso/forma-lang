...
if (hardFailure) {
  console.error(`forma-ocaml corpus elaboration failed: ${hardFailure.message}`);
  process.exit(1);
}
...
console.log(
  `forma-ocaml corpus elaborate report: loaded ${loaded}/${sources.length}, elaborated ${elaborated}/${sources.length}`,
);
